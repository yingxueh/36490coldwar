...
theme <- theme(axis.text = element_text(size = 12, color = "grey", family = "Times"),
        text = element_text(size = 18, face = "bold", color = "black", family = "Times"))
...
ggplot(degree.df, aes(x=V1, fill=V2)) +
  geom_histogram(bins=10, color="#e9ecef", alpha=.6, position = 'identity') +
  scale_fill_manual(values=c("#69b3a2", "#404080")) +
  xlab("Degree") +
  ggtitle("Westerners Tend to have more Connections") +
  geom_vline(aes(xintercept = mean(degree.df[east.indices,1])), color="#69b3a2") +
  geom_vline(aes(xintercept = mean(degree.df[west.indices,1])), color="#404080")

ggplot(degree.df, aes(x=V1, fill=V2)) +
  geom_density(color="#e9ecef", alpha=.6, position = 'identity') +
  scale_fill_manual(values=c("#69b3a2", "#404080")) +
  xlab("Degree") +
  ggtitle("Westerners Tend to have more Connections") +
  geom_vline(aes(xintercept = mean(degree.df[east.indices,1])), color="#69b3a2") +
